 ...
 * @author BergStudio
 */
public class v1_14_R1 implements Reflection{
    ...
    public v1_14_R1() {
        try {
            ...
            Logger.getLogger(v1_12_R1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public Set<String> getTagKeys(Object object) {
        return ((ItemStack) object).getTag().getKeys();
    }

    @Override
    public Set<String> getTagKeys(org.bukkit.inventory.ItemStack itemStack) {
        return ((ItemStack) asNMSCopy(itemStack)).getTag().getKeys();
    }
