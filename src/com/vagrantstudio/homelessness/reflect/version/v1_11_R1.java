 ...
 * @author BergStudio
 */
public class v1_11_R1 implements Reflection{
    ...
    public v1_11_R1() {
        try {
            ...
            Logger.getLogger(v1_11_R1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public Set<String> getTagKeys(Object object) {
        return ((net.minecraft.server.v1_11_R1.ItemStack) object).getTag().c();
    }
